...
def create_vector_database():
    ...
    try:
        ...
        print(f"Embedding model initialized with model name: {embed_model.model_name}")
...
response = qa.invoke({"query": "what are the sections discussed by government of karnantaka?"})
